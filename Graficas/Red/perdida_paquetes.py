...
latencias = {
    'rx_pps': 'Paquetes recibidos por segundo',
    'tx_pps': 'Paquetes enviados por segundo',
}
...
for u in usuarios:
    ...
    if not os.path.exists(path_csv):
        print(f"No encontrado: {path_csv}")
        for m in promedios:
...
plt.title("Tráfico de red - 10 muestras por cantidad de usuario")
...
plt.savefig(os.path.join(carpeta_graficas, "Red-PerdidaPaquetes.png"))