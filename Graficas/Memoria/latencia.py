...
plt.title("Latencias de Memoria - 10 muestras por cantidad de usuario. Escritura: bloques de 1024Kib.")
...
plt.savefig(os.path.join(carpeta_graficas, "Memoria-Latencia.png"))